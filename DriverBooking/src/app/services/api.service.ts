...
export class ApiService {
  ...
  AWS_Cloud: string = 'http://ec2-34-241-200-104.eu-west-1.compute.amazonaws.com:8081';
  AWS_Cloud_book: string = 'http://ec2-34-241-200-104.eu-west-1.compute.amazonaws.com:8081/api/booking';
